...
|event | `String` | Event array for the chart. e.g. `"events": {"dataPlotClick": function(eventObj) {console.log(eventObj); }, "dataplotRollOver": function(eventObj){console.log(eventObj); } }`|
